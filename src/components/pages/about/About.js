		...
		return (
			<section>
				<div className='contentView about mobileA11yText'>
					...
					<div className='hello'>
						<p>
							Привет! Я фронтенд-разработчик с трех-летним стажем. Придерживаюсь современных технологий
							JavaScript, интересуюсь новыми методиками и инструментами.
							Так же более 10 лет занимаюсь веб-маркетингом: разработка, дизайн и продвижение сайтов,
							построение рекламных сетей, ведение проектов.
						</p>
						<p>Владею необходимыми знаниями для создания современного веб-приложения (прогрессивно,
							адаптивно,
							облачно, мобильно). В 2017—2018 году предпочитаю использовать стек технологий ReactJS +
							Redux +
							ES6 вместе с WebPack.</p>
						<p>
							Я не только пишу код как фронтеэнд разработчик, но и активно интересуюсь и внедряю
							актуальные тренды дизайна и юзабилити интерфейсов в свои проекты. Люблю верстать и
							анимировать. Знаю о типографике и модульных сетках.
						</p>
						<p>
							В данный момент нахожусь в поиске творческого коллектива для совместной реализации крутых
							проектов!
						</p>
						<p>
